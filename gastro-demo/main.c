...
const char classes[CNN_NUM_OUTPUTS + 1][25] = {"1-esophagitis", "2-normal-cecum", "3-normal-pylorus", "4-normal-z-line", "5-polyps", "6-ulcerative-colitis", "?"};
...
int main(void)
{
    ...
    while (1) {
		...
		if (mx  > 50)
			TFT_Print(buff, 50, TFT_Y_START - 30, font_1,
                      snprintf(buff, sizeof(buff), "%s (%d%%)", classes[mx_index], mx));
